        ...
        {navItems.map(({ path, icon: Icon, label, isExternal }) => {
          ...
          if (isCallButton) {
            return (
              ...
              >
                <div
                  className="-mt-5 w-14 h-14 rounded-full flex items-center justify-center text-white shadow-lg shadow-[#16C75A]/40 ring-4 ring-background transition-all duration-150 active:scale-95 group-hover:brightness-110"
