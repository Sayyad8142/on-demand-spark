...
BEGIN
  ...
  IF COALESCE(v_worker.payout_ready, false) IS NOT TRUE THEN
    RETURN jsonb_build_object('success', false, 'error', 'Please add valid bank details before accepting bookings');
  END IF;
