-- Add total_requests_7d column to distinguish "no requests" from "0% acceptance"
ALTER TABLE public.workers
ADD COLUMN IF NOT EXISTS total_requests_7d integer NOT NULL DEFAULT 0;

-- Update recalc function to also store total_requests_7d
